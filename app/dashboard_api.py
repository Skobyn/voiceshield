...
def seed_mock_data():
    ...
    _school_configs.update({
        "school-1": {
            ...
            "admin_emails": ["admin@school-1.example.com", "principal@school-1.example.com"],
            "police_phone": "+15559110001",
            "police_email": "dispatch@local-pd.gov",
            "webhook_url": "https://hooks.slack.com/services/XXXXX",
            "attendance_webhook_url": "https://sis.school-1.example.com/api/attendance",
        ...
        "school-2": {
            ...
            "admin_emails": ["office@school-2.example.com"],
        ...
        "school-3": {
            ...
            "admin_emails": ["security@school-3.example.com", "principal@school-3.example.com"],
            "police_phone": "+15559110003",
            "police_email": "dispatch@local-pd.gov",
            "webhook_url": "https://hooks.slack.com/services/YYYYY",
            "attendance_webhook_url": "https://sis.school-3.example.com/webhook",
    ...
    mock_voicemails = [
        ...
        {"recording_sid": "REC-000", "caller": "BLOCKED", "called_number": "+15551001001", "school_id": "school-1",
         "transcript": "I placed a bomb inside the school. It's in the building right now and it's set to go off when the children arrive. You have until eight o'clock. Don't bother tracing this call.",
         ...
         "alert_sent": True, "alert_targets": ["admin@school-1.example.com", "principal@school-1.example.com", "dispatch@local-pd.gov", "+15559110001"]},

        # Today — attendance calls
        {"recording_sid": "REC-001", "caller": "+15551234567", "called_number": "+15551001099", "school_id": "school-1",
        ...
        {"recording_sid": "REC-002", "caller": "+15559876543", "called_number": "+15551001099", "school_id": "school-1",
        ...
        {"recording_sid": "REC-003", "caller": "+15557778888", "called_number": "+15552002099", "school_id": "school-2",
        ...
        {"recording_sid": "REC-004", "caller": "+15553216789", "called_number": "+15553003099", "school_id": "school-3",
        ...
        {"recording_sid": "REC-005", "caller": "+15554443333", "called_number": "+15551001001", "school_id": "school-1",
        ...
        # Yesterday
        {"recording_sid": "REC-006", "caller": "+15552223333", "called_number": "+15551001099", "school_id": "school-1",
        ...
        {"recording_sid": "REC-007", "caller": "+15558887777", "called_number": "+15553003099", "school_id": "school-3",
        ...
        {"recording_sid": "REC-008", "caller": "+15556665555", "called_number": "+15552002001", "school_id": "school-2",
        ...
        # 2 days ago
        {"recording_sid": "REC-009", "caller": "+15551112222", "called_number": "+15551001099", "school_id": "school-1",
        ...
        {"recording_sid": "REC-010", "caller": "+15559990000", "called_number": "+15553003001", "school_id": "school-3",
        ...
        # 3 days ago
        {"recording_sid": "REC-011", "caller": "+15554567890", "called_number": "+15553003099", "school_id": "school-3",
        ...
        {"recording_sid": "REC-012", "caller": "+15553334444", "called_number": "+15552002099", "school_id": "school-2",
        ...
        # 4-6 days ago
        {"recording_sid": "REC-013", "caller": "+15557776666", "called_number": "+15551001099", "school_id": "school-1",
        ...
        {"recording_sid": "REC-014", "caller": "+15554445555", "called_number": "+15552002001", "school_id": "school-2",
        ...
        {"recording_sid": "REC-015", "caller": "+15558889999", "called_number": "+15553003099", "school_id": "school-3",
        ...
        {"recording_sid": "REC-016", "caller": "+15551239876", "called_number": "+15551001001", "school_id": "school-1",
        ...
        {"recording_sid": "REC-017", "caller": "+15552348765", "called_number": "+15551001099", "school_id": "school-1",
         ...
         "attendance_record": {"student_name": "Jayden Taylor", "reason": "dentist cleaning", "date": (now - timedelta(days=6)).strftime("%Y-%m-%d"), "type": "early_pickup", "guardian": "Robert Taylor"}},
    ]
